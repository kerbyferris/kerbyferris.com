...
try{var o__34011__auto__ = f;
return goog.object.get(o__34011__auto__,"toString").call(o__34011__auto__);
}catch (e34091){var _ = e34091;
return "";
}});
...
var char_code = (function (){var o__34011__auto__ = (new String(char$));
return goog.object.get(o__34011__auto__,"charCodeAt").call(o__34011__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__34011__auto__ = String;
return goog.object.get(o__34011__auto__,"fromCharCode").call(o__34011__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__34093 = num_code;
switch (G__34093) {
case (1):
return (185);
...
var o__34011__auto__ = String;
return goog.object.get(o__34011__auto__,"fromCharCode").call(o__34011__auto__,superscript_code);
});
/**
...
}catch (e34099){var e__34036__auto__ = e34099;
return false;
}})())){
...
var vec__34100 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__34100,(0),null);
...
var o__34024__auto__ = temp__4657__auto__;
var temp__4657__auto____$1 = goog.object.get(o__34024__auto__,"dependencies_");
if(cljs.core.truth_(temp__4657__auto____$1)){
var o__34023__auto__ = temp__4657__auto____$1;
return goog.object.get(o__34023__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__21062__auto___34109 = arguments.length;
var i__21063__auto___34110 = (0);
while(true){
if((i__21063__auto___34110 < len__21062__auto___34109)){
args__21069__auto__.push((arguments[i__21063__auto___34110]));

var G__34111 = (i__21063__auto___34110 + (1));
i__21063__auto___34110 = G__34111;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21070__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__34105){
var vec__34106 = p__34105;
var ns_detector = cljs.core.nth.call(null,vec__34106,(0),null);
var effective_detector = (function (){var or__19987__auto__ = ns_detector;
...
var G__34112 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__34113 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__34112;
remaining_tokens = G__34113;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq34103){
var G__34104 = cljs.core.first.call(null,seq34103);
var seq34103__$1 = cljs.core.next.call(null,seq34103);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__34104,seq34103__$1);
});
...
break;
default:
var o__34011__auto__ = window;
return goog.object.get(o__34011__auto__,"parseInt").call(o__34011__auto__,arity,(10));
...
var vec__34121 = cljs.core.split_with.call(null,(function (p1__34117_SHARP_){
return cljs.core.not_EQ_.call(null,p1__34117_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__34121,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__34121,(1),null);
...
var vec__34127 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__34127,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__34127,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__34130 = cljs.core.rest.call(null,remaining_tokens);
var G__34131 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__34130;
name_tokens = G__34131;
continue;
} else {
...
var args34132 = [];
var len__21062__auto___34144 = arguments.length;
var i__21063__auto___34145 = (0);
while(true){
if((i__21063__auto___34145 < len__21062__auto___34144)){
args34132.push((arguments[i__21063__auto___34145]));

var G__34146 = (i__21063__auto___34145 + (1));
i__21063__auto___34145 = G__34146;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args34132.length)].join('')));
...
var vec__34135 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__34135,(0),null);
var arity = cljs.core.nth.call(null,vec__34135,(1),null);
var vec__34138 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__34138,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__34138,(1),null);
var vec__34141 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__34141,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__34141,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__34141,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__34141,(3),null);
...
var args34148 = [];
var len__21062__auto___34154 = arguments.length;
var i__21063__auto___34155 = (0);
while(true){
if((i__21063__auto___34155 < len__21062__auto___34154)){
args34148.push((arguments[i__21063__auto___34155]));

var G__34156 = (i__21063__auto___34155 + (1));
i__21063__auto___34155 = G__34156;
continue;
} else {
}
break;
...
var vec__34151 = result;
var munged_ns = cljs.core.nth.call(null,vec__34151,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__34151,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__34151,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__34151,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__34151,(4),null);
var arity = cljs.core.nth.call(null,vec__34151,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__34164 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__34164,(0),null);
var args = cljs.core.nth.call(null,vec__34164,(1),null);
var vec__34167 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__34167,(0),null);
var name = cljs.core.nth.call(null,vec__34167,(1),null);
...
var G__34170 = (arity + (1));
var G__34171 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__34172){
var vec__34176 = p__34172;
var arity = cljs.core.nth.call(null,vec__34176,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__34176,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__19987__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__34179_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__34180_SHARP_);
...
var args__21069__auto__ = [];
var len__21062__auto___34187 = arguments.length;
var i__21063__auto___34188 = (0);
while(true){
if((i__21063__auto___34188 < len__21062__auto___34187)){
args__21069__auto__.push((arguments[i__21063__auto___34188]));

var G__34189 = (i__21063__auto___34188 + (1));
i__21063__auto___34188 = G__34189;
continue;
} else {
}
break;
...
var argseq__21070__auto__ = ((((1) < args__21069__auto__.length))?(new cljs.core.IndexedSeq(args__21069__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__21070__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__34183){
var vec__34184 = p__34183;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__34184,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq34181){
var G__34182 = cljs.core.first.call(null,seq34181);
var seq34181__$1 = cljs.core.next.call(null,seq34181);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__34182,seq34181__$1);
});
...
var G__34191 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__34191) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__19987__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__19975__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__19987__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__34198__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__34198__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__34198__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__34198__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__34199 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__34199,(0),null);
var fn_name = cljs.core.nth.call(null,vec__34199,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__34199,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__34199,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__34199,(4),null);
var arity = cljs.core.nth.call(null,vec__34199,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__19975__auto__ = protocol_ns;
if(cljs.core.truth_(and__19975__auto__)){
return cljs.core.not.call(null,(function (){var and__19975__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__19987__auto__ = protocol_part;
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
return fn_part;
...
//# sourceMappingURL=munging.js.map?rel=1539454402519