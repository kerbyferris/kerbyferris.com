...
var or__19987__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
var or__19987__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__19987__auto____$1)){
return or__19987__auto____$1;
} else {
var or__19987__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__19987__auto____$2)){
return or__19987__auto____$2;
} else {
var or__19987__auto____$3 = (w["msRequestAnimationFrame"]);
...
var n__20902__auto__ = a.length;
var i = (0);
while(true){
if((i < n__20902__auto__)){
var c_22819 = (a[i]);
if(cljs.core.truth_((c_22819["cljsIsDirty"]))){
(c_22819["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__20593__auto__,writer__20594__auto__,opt__20595__auto__){
return cljs.core._write.call(null,writer__20594__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__22823 = c;
var G__22823__$1 = (((G__22823 == null))?null:(G__22823["props"]));
if((G__22823__$1 == null)){
return null;
} else {
return (G__22823__$1["argv"]);
}
});
...
var G__22825_22826 = (c["cljsRatom"]);
if((G__22825_22826 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__22825_22826);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1539454392302