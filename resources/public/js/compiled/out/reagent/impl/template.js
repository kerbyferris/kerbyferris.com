...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__20593__auto__,writer__20594__auto__,opt__20595__auto__){
return cljs.core._write.call(null,writer__20594__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__19987__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__19987__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__19987__auto__)){
return or__19987__auto__;
} else {
...
var G__22883 = o;
(G__22883[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_22887 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_22887))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_22887)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__19975__auto__ = (node === document.activeElement);
if(and__19975__auto__){
var and__19975__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__19975__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__22890 = jsprops;
(G__22890["defaultValue"] = value);

(G__22890["onChange"] = ((function (G__22890,v,value,on_change){
return (function (p1__22888_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__22888_SHARP_);
});})(G__22890,v,value,on_change))
);
...
var vec__22894 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__22894,(0),null);
var id = cljs.core.nth.call(null,vec__22894,(1),null);
var class$ = cljs.core.nth.call(null,vec__22894,(2),null);
...
var temp__4659__auto__ = (function (){var G__22900 = cljs.core.meta.call(null,v);
if((G__22900 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22900);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__22902_22903 = v;
var G__22902_22904__$1 = (((G__22902_22903 == null))?null:reagent.impl.template.key_from_vec.call(null,G__22902_22903));
if((G__22902_22904__$1 == null)){
} else {
(jsprops["key"] = G__22902_22904__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__22907 = cljs.core.meta.call(null,argv);
if((G__22907 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__22907);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__22908 = (((jsprops == null))?{}:jsprops);
(G__22908["key"] = key);
...
var G__22909 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__22909;
continue;
}
} else {
...
var n__20902__auto___22910 = a.length;
var i_22911 = (0);
while(true){
if((i_22911 < n__20902__auto___22910)){
(a[i_22911] = reagent.impl.template.as_element.call(null,(a[i_22911])));
...
var a = cljs.core.into_array.call(null,s);
var n__20902__auto___22913 = a.length;
var i_22914 = (0);
while(true){
if((i_22914 < n__20902__auto___22913)){
var val_22915 = (a[i_22914]);
if((cljs.core.vector_QMARK_.call(null,val_22915)) && ((reagent.impl.template.key_from_vec.call(null,val_22915) == null))){
(o["no-key"] = true);
} else {
}

(a[i_22914] = reagent.impl.template.as_element.call(null,val_22915));

var G__22916 = (i_22914 + (1));
i_22914 = G__22916;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__19975__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__19975__auto__){
return (ctx["no-key"]);
} else {
return and__19975__auto__;
...
var G__22918 = (cljs.core.count.call(null,argv) - first_child);
switch (G__22918) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__22918){
...
//# sourceMappingURL=template.js.map?rel=1539454392582